RSpec.feature 'Landing page, consumer requires help with their pension in person',
              vcr: vcr_options_for_feature(:landing_face_to_face_filter_for_pension_advice) do
