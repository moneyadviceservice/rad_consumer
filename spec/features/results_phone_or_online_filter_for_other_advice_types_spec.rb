RSpec.feature 'Results page, consumer requires various types of advice over the phone or online',
  ...
  def and_firms_with_advisers_were_previously_indexed
    with_fresh_index! do
      @second = create(:firm, retirement_income_products_flag: true, wills_and_probate_flag: true, in_person_advice_methods: [], other_advice_methods: @other_advice_methods, registered_name: 'second')
      @leicester = create(:adviser, firm: @second, latitude: 52.633013, longitude: -1.131257)
      @first = create(:firm, retirement_income_products_flag: true, wills_and_probate_flag: true, in_person_advice_methods: [], other_advice_methods: @other_advice_methods, registered_name: 'first')
      @glasgow = create(:adviser, firm: @first, latitude: 55.856191, longitude: -4.247082)

      @excluded = create(:firm, retirement_income_products_flag: true, in_person_advice_methods: [], other_advice_methods: @other_advice_methods)
      ...
      create(:firm, retirement_income_products_flag: true, in_person_advice_methods: @in_person_advice_methods, other_advice_methods: @other_advice_methods) do |f|
