RSpec.feature 'Consumer views advice filters on search results page',
  ...
  def given_some_firms_were_indexed
    with_fresh_index! do
      @wills_firm       = create(:firm, registered_name: 'The Willers Ltd',    wills_and_probate_flag: true)
      @equity_firm      = create(:firm, registered_name: 'The Equiters Ltd',   equity_release_flag: true)
      @inheritance_firm = create(:firm, registered_name: 'Estate Traders Ltd', inheritance_tax_and_estate_planning_flag: true)
