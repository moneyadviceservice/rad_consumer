RSpec.feature 'Landing page, consumer requires help with their pension over the phone or online',
              vcr: vcr_options_for_feature(:landing_phone_or_online_filter_for_pension_advice) do
